...
export function Login({ onAuthenticated }: LoginProps) {
  const [email, setEmail] = useState("analyst@terralens.app");
  const [password, setPassword] = useState("LocalAccess123!");
      ...
      <section className="login-panel">
        <form className="login-card" onSubmit={submit}>
          ...
          <div className="local-note">
            <span>LOCAL</span>
            Credentials are prefilled for this private workspace.
          </div>
        </form>
